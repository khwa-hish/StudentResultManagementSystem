...
class CourseClass:
    def __init__(self,home):
        ...
        self.home.geometry(f"{screen_width}x{screen_height}+0+0")
        #self.home.geometry("1200x500+80+170")
        self.home.config(bg="white")
        self.home.focus_force()

    #Title of Course
        title=Label(self.home,text="Manage Course",font=("times new roman",20,"bold"),bg="darkmagenta",fg="white").place(x=0,y=0,relwidth=1,height=40)
    #Variables
    ...
    #Search Panel
        ...
        btn_search=Button(self.home,text="Search",font=("times new roman",15,"bold"),bg="darkblue",fg="white",cursor="hand2",command=self.search).place(x=1100,y=60,width=90,height=30)
        
    #Content
        self.C_Frame=Frame(self.home,bd=2,relief=RIDGE)
        self.C_Frame.place(x=720,y=100,width=800,height=200)
...
#--------------database----------------------------------
#Adding name,duration, discription and showing pop messages on pc according to that
