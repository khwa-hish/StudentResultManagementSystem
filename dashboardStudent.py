...
class studentSystem:
    def __init__(self,home):
        ...
        title=Label(self.home,text="Student Result",font=("times new roman",20,"bold"),bg="dodgerblue",fg="white").place(x=0,y=0,relwidth=1,height=50)
        ...
        btn_search=Button(self.home,text="Search",font=("times new roman",15,"bold"),bg="darkblue",fg="white",cursor="hand2",command=self.search).place(x=900,y=70,width=100,height=35)
        btn_clear=Button(self.home,text="Clear",font=("times new roman",15,"bold"),bg="chartreuse",fg="white",cursor="hand2",command=self.clear).place(x=1020,y=70,width=100,height=35)
